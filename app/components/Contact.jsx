  ...
  return (
    ...
    <motion.div
      ...
      <motion.p
        ...
        I'd love to here from you! If you have any questions, comments, or feedbck,
      ...
      <motion.form
        ...
        <div className='flex flex-col sm:flex-row sm:justify-between gap-6 mt-10 mb-8'>
